...
export const BusinessTemplate = ({ resumeData, variant }: BusinessTemplateProps) => {
  ...
  return (
    <div className="bg-white text-black font-serif">
      {/* Executive Header */}
      <div className="border-t-4 border-b pt-4 pb-4 mb-6" style={{ borderColor: color.replace('text-', '') }}>
        <div className="text-center">
          {personalInfo.photo && (
            <img src={personalInfo.photo} alt={personalInfo.fullName} className="w-24 h-24 rounded-full object-cover mx-auto mb-3" />
          )}
          <h1 className={`text-4xl font-bold ${color}`}>{personalInfo.fullName || 'YOUR NAME'}</h1>
      ...
      {summary && (
        <div className="mb-6">
          <h2 className={`text-xl font-bold ${color} border-b-2 pb-1 mb-3 uppercase tracking-wide`}>Executive Summary</h2>
      ...
      {workExperience.length > 0 && (
        <div className="mb-6">
          <h2 className={`text-xl font-bold ${color} border-b-2 pb-1 mb-3 uppercase tracking-wide`}>Professional Experience</h2>
      ...
      {education.length > 0 && (
        <div className="mb-6">
          <h2 className={`text-xl font-bold ${color} border-b-2 pb-1 mb-3 uppercase tracking-wide`}>Education</h2>
      ...
      {skills.length > 0 && (
        <div className="mb-6">
          <h2 className={`text-xl font-bold ${color} border-b-2 pb-1 mb-3 uppercase tracking-wide`}>Core Competencies</h2>
      ...
      {certifications.length > 0 && (
        <div className="mb-6">
          <h2 className={`text-xl font-bold ${color} border-b-2 pb-1 mb-3 uppercase tracking-wide`}>Professional Certifications</h2>
      ...
      {projects.length > 0 && (
        <div>
          <h2 className={`text-xl font-bold ${color} border-b-2 pb-1 mb-3 uppercase tracking-wide`}>Key Achievements</h2>
          <div className="space-y-3">
